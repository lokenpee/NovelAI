...
export function renderWorkspace(project = {}, { openChapterId = null, openCategoryIds = new Set(), openEntryIds = new Set(), isProcessing = false, collapsedSections } = {}) {
